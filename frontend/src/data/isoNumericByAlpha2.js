// Maps ISO 3166-1 alpha-2 country codes (what ransomware.live returns, and
// what our RansomwareVictim.country column stores) to ISO 3166-1 numeric
// codes (the "id" field used by the world-atlas TopoJSON in
// public/data/countries-110m.json). Generated from the authoritative
// `iso-3166-1` npm package's dataset — not hand-typed, so it's not subject
// to transcription slips on the less common codes.
export const ISO_NUMERIC_BY_ALPHA2 = {
...
// Reverse lookup (numeric -> alpha-2), built once at module load.
export const ALPHA2_BY_ISO_NUMERIC = Object.fromEntries(
  Object.entries(ISO_NUMERIC_BY_ALPHA2).map(([a2, num]) => [num, a2])
);
