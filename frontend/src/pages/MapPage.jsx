...
export default function MapPage() {
  ...
  const selectedEntry = useMemo(
    () => (selected && countries ? countries.find((c) => c.country === selected) : null),
    [selected, countries]
  );
              ...
              <aside className="map-sidebar">
                  ...
                  <div className="map-detail-card">
                    ...
                    <div className="map-detail-stats">
                      <div className="map-detail-stat">
                        <span className="map-detail-num">{selectedEntry.count}</span>
                        <span>Incidents</span>
                      </div>
                ...
                <div className="map-guidance-card">
                  <h4>
                    ...
                    <span className="map-guidance-tag">Not incident-specific</span>
                  </h4>
                  <p className="map-guidance-note">
                    {selectedEntry?.top_group
                      ? `No dataset records what any country actually did in response to an attack. Here's standard, publicly-published guidance for defending against groups like ${selectedEntry.top_group}:`
                      : "No dataset records what any country actually did in response to an attack. Here's standard, publicly-published guidance for defending against ransomware in general:"}
                  </p>
